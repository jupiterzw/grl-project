...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--flag_step_size', type=float, default=0.005,
                        help='step size for FLAG adversarial perturbation')
    parser.add_argument('--flag_ascent_steps', type=int, default=3,
                        help='number of ascent steps for FLAG')
